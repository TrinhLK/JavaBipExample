...
import trinhlk.bip.core.api.Data;
import trinhlk.bip.core.api.Executor;
import trinhlk.bip.core.api.Identifiable;
...
public class TunellingExecutorHandler implements InvocationHandler {
	...
	public TunellingExecutorHandler(OrchestratedExecutor executor, Object bipSpec) {
		...
		if (classAnnotation instanceof Ports) {
			...
			for (trinhlk.bip.core.annotations.Port annotation : portArray) {

				if (annotation instanceof trinhlk.bip.core.annotations.Port) {
					Port portAnnotation = (trinhlk.bip.core.annotations.Port) annotation;
		...
		for (Method method : componentMethods) {
			...
			for (Annotation annotation : annotations) {
				if (annotation instanceof trinhlk.bip.core.annotations.Transition) {
					...
					parseTransition(method, (trinhlk.bip.core.annotations.Transition) annotation, namesOfSpontaneousPorts);
					...
					for (Annotation bipTransitionAnnotation : transitionAnnotations) {
						...
						parseTransition(method, (trinhlk.bip.core.annotations.Transition) bipTransitionAnnotation,
