...
class BehaviourImpl implements ExecutableBehaviour {
	...
	public Map<String, Boolean> computeGuardsWithoutData(String currentState) throws IllegalAccessException, InvocationTargetException  {
