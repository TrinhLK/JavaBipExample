...
class ReflectionHelper {
	...
	public static List<Data<?>> parseDataAnnotations(Method method) {
		...
		for (int i = 0; i < paramsAnnotations.length; i++) {
			for (Annotation annotation : paramsAnnotations[i]) {
				if (annotation instanceof trinhlk.bip.core.annotations.Data) {
					trinhlk.bip.core.annotations.Data dataAnnotation = (trinhlk.bip.core.annotations.Data) annotation;
	...
	public static DataOutImpl<?> parseReturnDataAnnotation(Method method) {
		...
		for (Annotation annotation : annotations) {
			if (annotation instanceof trinhlk.bip.core.annotations.Data) { // DATA OUT
				return parseReturnDataAnnotation(method, (trinhlk.bip.core.annotations.Data) annotation);
			}
		}
	 ...
	 * @return a new instance of DataOut
	 */
	public static DataOutImpl<?> parseReturnDataAnnotation(Method method, trinhlk.bip.core.annotations.Data dataAnnotation) {
