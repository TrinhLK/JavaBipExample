 ...
 */
package trinhlk.bip.engine.coordinator;
...
import trinhlk.bip.core.api.BIPComponent;
import trinhlk.bip.core.api.BIPGlue;
import trinhlk.bip.core.api.Behaviour;
import trinhlk.bip.core.api.OrchestratedExecutor;
import trinhlk.bip.core.api.Port;
...
import trinhlk.bip.engine.api.InteractionExecutor;
import trinhlk.bip.core.exceptions.BIPEngineException;
import trinhlk.bip.executor.ExecutorKernel;
import trinhlk.bip.executor.TunellingExecutorHandler;
...
public class BIPCoordinatorImpl implements BIPCoordinator, Runnable {
	...
	public synchronized BIPActor register(Object component, String id, boolean useSpec) {
		if (registeredComponents.contains(component)) {
			...
			// }
			logger.info("******************************************************************************");
			trinhlk.bip.core.api.BIPEngine typedActorEngine = (trinhlk.bip.core.api.BIPEngine) typedActorSelf;
